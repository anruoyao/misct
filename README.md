...
## Summary
- Implemented a toggle for enabling/disabling maintenance mode in the settings with message.
- Implemented a toggle for enabling/disabling Force app update in the settings.
...
- [bootstrap.min.js](public/asset/js/bootstrap.min.js)
...
#### Database
settings : Fields added : is_maintenance_mode, maintenance_message, is_force_app_update, android_app_version, ios_app_version
...
#### Database
settings : Fields added : play_store_download_link, app_store_download_link, uri_scheme
