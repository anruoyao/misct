...
@section('content')
    <div class="mb-3 card-tab">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="setting-Tab" data-bs-toggle="tab" data-bs-target="#setting-pane"
                    type="button" role="tab" aria-controls="setting-panel" aria-selected="true"> {{ __('setting') }}
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="limit-tab" data-bs-toggle="tab" data-bs-target="#limit-pane" type="button"
                    role="tab" aria-controls="limit-pane" aria-selected="false"> {{ __('limits') }} </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="documentType-Tab" data-bs-toggle="tab" data-bs-target="#documentType-pane"
                    type="button" role="tab" aria-controls="documentType-panel" aria-selected="true">
                    {{ __('documentType') }} </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="reportReason-Tab" data-bs-toggle="tab" data-bs-target="#reportReason-pane"
                    type="button" role="tab" aria-controls="reportReason-panel" aria-selected="true">
                    {{ __('reportReason') }} </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="sightEngine-Tab" data-bs-toggle="tab" data-bs-target="#sightEngine-pane"
                    type="button" role="tab" aria-controls="sightEngine-panel" aria-selected="true">
                    {{ __('sightEngine') }} </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="deeplinking-Tab" data-bs-toggle="tab" data-bs-target="#deeplinking-pane"
                    type="button" role="tab" aria-controls="deeplinking-panel" aria-selected="true">
                    {{ __('deeplink') }} </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="maintenance-Tab" data-bs-toggle="tab" data-bs-target="#maintenance-pane"
                    type="button" role="tab" aria-controls="maintenance-panel" aria-selected="true">
                    {{ __('maintenanceMode') }} </button>
            </li>
        </ul>
    </div>
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane show active" id="setting-pane" role="tabpanel" tabindex="0">
            <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="appName"
                                                class="form-label">{{ __('fetchPostTypeOnHomePage') }}</label>
                                            <div class="form">
                                                <section class="plan mb-3">
                                                    <label class="free-label four col">
                                                        <input type="radio" name="fetch_post_type" id="random"
                                                            value="0"
                                                            {{ $setting->fetch_post_type == 0 ? 'checked' : '' }}>
                                                        {{ __('random') }}
                                                    </label>
                                                    <label class="basic-label four col">
                                                        <input type="radio" name="fetch_post_type" id="latest"
                                                            value="1"
                                                            {{ $setting->fetch_post_type == 1 ? 'checked' : '' }}>
                                                        {{ __('latest') }}
                                                    </label>
                                                </section>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="support_email"
                                                class="form-label">{{ __('supportEmail') }}</label>
                                            <input type="text" class="form-control" name="support_email"
                                                id="support_email" value="{{ $setting->support_email }}">
                                        </div>
                                            ...
                                            <div class="input-group">
                                                <label class="input-group-btn">
                                                    <span class="btn btn-primary">
                                                        Choose File <input type="file" id="favicon" name="favicon"
                                                ...
                                                <div class="ms-3" id="favicon-preview">
                                                    <img id="faviconImage" src="" alt="Image Preview"
                                                        class="img-fluid"
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="card w-auto p-3">
                                                    <div
                                                        class="checkbox-slider d-flex align-items-center justify-content-between">
                                                        <span class="me-3">
                                                            {{ __('local') }}
                                                        </span>
                                                        <label class="switch m-0">
                                                            <input type="radio" name="storage_type" value="0"
                                                                id="localRadio"
                                                ...
                                                <div class="card w-auto p-3">
                                                    <div
                                                        ...
                                                        <span class="me-3">
                                                            {{ __('AWSS3') }}
                                                            <br>
                                                            <span id="awsNote" class="text-danger">
                                                                {{ __('pleaseAddValuesInEnvFile') }} </span>
                                                        </span>
                                                        <label class="switch m-0">
                                                            <input type="radio" name="storage_type" value="1"
                                                                id="awsRadio"
                                                                {{ $setting->storage_type == 1 ? 'checked' : '' }}>
                                                            <span class="slider"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card w-auto p-3">
                                                    <div
                                                        ...
                                                        <span class="me-3">
                                                            ...
                                                            <br>
                                                            <span id="doNote" class="text-danger">
                                                                {{ __('pleaseAddValuesInEnvFile') }} </span>
                                                        </span>
                                                        <label class="switch m-0">
                                                            <input type="radio" name="storage_type" value="2"
                                                                id="doRadio"
                                                                {{ $setting->storage_type == 2 ? 'checked' : '' }}>
                                                            <span class="slider"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="card w-auto p-3">
                                                        <div
                                                            ...
                                                            <label class="switch m-0">
                                                                <input type="hidden" name="is_in_app_purchase_enabled"
                                                                    id="is_in_app_purchase_enabled_hidden"
                                                                    value="{{ $setting->is_in_app_purchase_enabled }}">
                                                                <input type="checkbox" id="is_in_app_purchase_enabled"
                                                                    {{ $setting->is_in_app_purchase_enabled == 1 ? 'checked' : '' }}>
                                                                <span class="slider"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal-footer p-0">
                                        ...
                                        <button type="submit"
                                            class="btn theme-btn text-white">{{ __('save') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-3">
                    <form id="forceAppUpdateForm" method="POST">
                        <div class="card">
                            <div class="card-header">
                                <div class="page-title w-100">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h4 class="mb-0 fw-normal">{{ __('forceAppUpdate') }}</h4>
                                        <label class="switch m-0">
                                            <input type="hidden" name="is_force_app_update" id="is_force_app_update"
                                                value="{{ $setting->is_force_app_update }}">
                                            <input type="checkbox" id="force_app_update_enabled"
                                                {{ $setting->is_force_app_update == 1 ? 'checked' : '' }}>
                                            <span class="slider"></span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label for="android_app_version"
                                                class="form-label">{{ __('androidAppVersion') }}</label>
                                            <input type="text" class="form-control" name="android_app_version"
                                                id="android_app_version" value="{{ $setting->android_app_version }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label for="ios_app_version" class="form-label">{{ __('iosAppVersion') }}</label>
                                            <input type="text" class="form-control" name="ios_app_version"
                                                id="ios_app_version" value="{{ $setting->ios_app_version }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer p-0">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="setRoomUsersLimit" method="POST">
                                <div class="form-group">
                                    <label for="setRoomUsersLimitInput"
                                        class="form-label">{{ __('setRoomUsersLimit') }}</label>
                                    <input type="number" class="form-control" name="setRoomUsersLimit"
                                        id="setRoomUsersLimitInput" required=""
                            ...
                            <form id="minuteLimitForm" method="POST">
                                    ...
                                    <div class="col-12">
                                        <div class="w-auto ps-4 py-1 pe-1 mb-2 border rounded-5">
                                            <div class=" d-flex align-items-center justify-content-between m-0">
                                                <label for="minuteLimitInStories"
                                                    class="form-label m-0 text-nowrap">{{ __('createStoryDuration') }}
                                                    <span class="text-dark opacity-25"> {{ __('minutes') }}</span></label>
                                                <input type="number" class="form-control ms-3"
                                                    name="minute_limit_in_creating_story" id="minuteLimitInStories"
                                                    required=""
                                                    value="{{ $setting->minute_limit_in_creating_story }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="w-auto ps-4 py-1 pe-1 mb-2 border rounded-5">
                                            <div class=" d-flex align-items-center justify-content-between m-0">
                                                <label for="minuteLimitInChoosingVideoForStory"
                                                    class="form-label m-0 text-nowrap">{{ __('videoLimitforStories') }}
                                                    <span class="text-dark opacity-25"> {{ __('minutes') }}
                                                    </span></label>
                                                <input type="number" class="form-control ms-3"
                                                    name="minute_limit_in_choosing_video_for_story"
                                                    id="minuteLimitInChoosingVideoForStory" required=""
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="w-auto ps-4 py-1 pe-1 mb-2 border rounded-5">
                                            <div class=" d-flex align-items-center justify-content-between m-0">
                                                <label for="minuteLimitInChoosingVideoForPost"
                                                    class="form-label m-0 text-nowrap">{{ __('videoLimitforPosts') }}
                                                    <span class="text-dark opacity-25"> {{ __('minutes') }}
                                                    </span></label>
                                                <input type="number" class="form-control ms-3"
                                                    name="minute_limit_in_choosing_video_for_post"
                                                    id="minuteLimitInChoosingVideoForPost" required=""
                                    ...
                                    <div class="col-12">
                                        <div class="w-auto ps-4 py-1 pe-1 mb-2 border rounded-5">
                                            <div class=" d-flex align-items-center justify-content-between m-0">
                                                <label for="uploadMaxPerPost"
                                                    class="form-label m-0 text-nowrap">{{ __('maxImagesPerPost') }}</label>
                                                <input type="number" class="form-control ms-3"
                                                    name="max_images_can_be_uploaded_in_one_post" id="uploadMaxPerPost"
                                                    required=""
                                                    value="{{ $setting->max_images_can_be_uploaded_in_one_post }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="w-auto ps-4 py-1 pe-1 mb-2 border rounded-5">
                                            <div class=" d-flex align-items-center justify-content-between m-0">
                                                <label for="minuteLimitInAudioPost"
                                                    class="form-label m-0 text-nowrap">{{ __('audioLimitforPosts') }}
                                                    <span class="text-dark opacity-25"> {{ __('minutes') }}
                                                    </span></label>
                                                <input type="number" class="form-control ms-3"
                                                    name="minute_limit_in_audio_post" id="minuteLimitInAudioPost"
                                                    required="" value="{{ $setting->minute_limit_in_audio_post }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="w-auto ps-4 py-1 pe-1 mb-2 border rounded-5">
                                            <div class=" d-flex align-items-center justify-content-between m-0">
                                                <label for="durationLimitInReel"
                                                    class="form-label m-0 text-nowrap">{{ __('durationLimitInReel') }}
                                                    <span class="text-dark opacity-25"> {{ __('second') }}
                                                    </span></label>
                                                <input type="number" class="form-control ms-3"
                                                    name="duration_limit_in_reel" id="durationLimitInReel" required=""
                                                    value="{{ $setting->duration_limit_in_reel }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <form id="audioLimitForm" method="POST">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label for="audio_space_hosts_limit"
                                                class="form-label">{{ __('audioSpaceHostsLimit') }} <span
                                                    class="text-dark opacity-25"> {{ __('enter0ForNoLimit') }}
                                                </span></label>
                                            <input type="number" class="form-control" name="audio_space_hosts_limit"
                                                id="audio_space_hosts_limit" required=""
                                                value="{{ $setting->audio_space_hosts_limit }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label for="audio_space_listeners_limit"
                                                class="form-label">{{ __('audioSapceListenersLimit') }} <span
                                                    class="text-dark opacity-25"> {{ __('enter0ForNoLimit') }} </span>
                                            </label>
                                            <input type="number" class="form-control" name="audio_space_listeners_limit"
                                                id="audio_space_listeners_limit" required=""
                                                value="{{ $setting->audio_space_listeners_limit }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label for="audio_space_duration_in_minutes"
                                                class="form-label">{{ __('audioSpaceDurationInMinutes') }} <span
                                                    class="text-dark opacity-25"> {{ __('enter0ForNoLimit') }} </span>
                                            </label>
                                            <input type="number" class="form-control"
                                                name="audio_space_duration_in_minutes"
                                                id="audio_space_duration_in_minutes" required=""
                                                value="{{ $setting->audio_space_duration_in_minutes }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer p-0">
                    ...
                    <div class="card-header">
                        <div class="page-title w-100">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <label class="switch m-0">
                                    <input type="checkbox" name="is_sight_engine_enabled" id="is_sight_engine_enabled"
                                        value="{{ $setting->is_sight_engine_enabled }}"
                                        {{ $setting->is_sight_engine_enabled == 1 ? 'checked' : '' }}>
                                    <span class="slider"></span>
                                </label>
                            </div>
                            <p class="m-0 text-muted fw-normal">If You keep this on and add all required credentials from
                                SightEngine, App will refuse sensitive videos to be uploaded.</p>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @if (session('user_type') == 0)
                                        <input type="text" class="form-control" name="sight_engine_api_user"
                                            id="sight_engine_api_user" required value="">
                                    @else
                                        <input type="text" class="form-control" name="sight_engine_api_user"
                                            id="sight_engine_api_user" required
                                            value="{{ $setting->sight_engine_api_user }}">
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    @if (session('user_type') == 0)
                                        <input type="text" class="form-control" name="sight_engine_api_secret"
                                            id="sight_engine_api_secret" required value="">
                                    @else
                                        <input type="text" class="form-control" name="sight_engine_api_secret"
                                            id="sight_engine_api_secret" required
                                            value="{{ $setting->sight_engine_api_secret }}">
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label for="sight_engine_image_workflow_id"
                                        class="form-label">{{ __('imageWorkflowId') }}</label>
                                    @if (session('user_type') == 0)
                                        <input type="text" class="form-control" name="sight_engine_image_workflow_id"
                                            id="sight_engine_image_workflow_id" required value="">
                                    @else
                                        <input type="text" class="form-control" name="sight_engine_image_workflow_id"
                                            id="sight_engine_image_workflow_id" required
                                            value="{{ $setting->sight_engine_image_workflow_id }}">
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label for="sight_engine_video_workflow_id"
                                        class="form-label">{{ __('videoWorkflowId') }}</label>
                                    @if (session('user_type') == 0)
                                        <input type="text" class="form-control" name="sight_engine_video_workflow_id"
                                            id="sight_engine_video_workflow_id" required value="">
                                    @else
                                        <input type="text" class="form-control" name="sight_engine_video_workflow_id"
                                            id="sight_engine_video_workflow_id" required
                                            value="{{ $setting->sight_engine_video_workflow_id }}">
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-1">
                                    <label for="uri_scheme" class="form-label">{{ __('URI Scheme') }}
                                        <button type="button" class="btn btn-secondary p-0 tooltip-icon"
                            ...
                            <div class="col-md-4">
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" id="app_store_download_link"
                                        name="app_store_download_link" value="{{ $setting->app_store_download_link }}">
                                </div>
                            </div>
                        </div>
                        <hr>
                                ...
                                <div class="row">
                                    <div class="mb-3">
                                        <label for="package_name" class="form-label">
                                            {{ __('Package Name') }}
                                            <a href="https://docs.retrytech.com/find_package_name_android" target="_blank"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">{{ __('SHA 256 Keys') }}
                                            <a href="https://docs.retrytech.com/how_to_get_sha256_key" target="_blank"
                                                type="button" class="btn btn-secondary p-0 tooltip-icon">
                                                ?
                                            </a>
                                        </label>
                                        <div id="shaContainer">
                                            ...
                                            @else
                                                <div class="input-group mb-2 sha-field">
                                                    <input type="text" class="form-control sha-input" name="sha_256[]"
                                                        placeholder="Enter SHA 256">
                                                    <button type="button" class="btn btn-danger remove-sha">-</button>
                                                </div>
                                            @endif
                                        </div>
                                        <button type="button" class="btn btn-sm btn-success mt-1" id="addSha">+ Add
                                            SHA</button>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row">
                                    <div class="mb-3">
                                        <label for="package_name_ios"
                                            class="form-label">{{ __('Bundle Id / Package Name') }}
                                            <a href="https://docs.retrytech.com/find_bundle_id_ios" target="_blank"
                                                type="button" class="btn btn-secondary p-0 tooltip-icon">
                                                ?
                                            </a>
                                    ...
                                    <div class="mb-3">
                                        <label for="team_id" class="form-label">{{ __('Team Id') }}
                                            <a href="https://docs.retrytech.com/find_team_id" target="_blank"
                                                type="button" class="btn btn-secondary p-0 tooltip-icon">
                                                ?
                                            </a>
                                        </label>
        ...
        <div class="tab-pane" id="maintenance-pane" role="tabpanel" tabindex="0">
            <div class="row">
                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="card w-auto p-3">
                                            <div class="checkbox-slider d-flex align-items-center justify-content-between">
                                                ...
                                                <label class="switch m-0">
                                                    <input type="hidden" name="is_maintenance_mode"
                                                        id="is_maintenance_mode"
                                                        value="{{ $setting->is_maintenance_mode }}">
                                                    <input type="checkbox" id="maintenance_mode_enabled"
                                                        {{ $setting->is_maintenance_mode == 1 ? 'checked' : '' }}>
                                                    <span class="slider"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="mb-3">
                                            <label for="maintenance_message"
                                                class="form-label">{{ __('maintenanceMessage') }}</label>
                                            <textarea class="form-control" name="maintenance_message" id="maintenance_message">{{ $setting->maintenance_message }}</textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer p-0">
                                        <button type="button" class="btn"></button>
    ...
    <!-- Document Type Modal -->
    <div class="modal fade" id="documentTypeModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <form id="editDocumentTypeForm" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" id="editDocumentType"
                                required="">
                        </div>
                    </div>
                    <div class="modal-footer">
