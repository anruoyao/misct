...
class AdminController extends Controller
{
    ...
    public function changePassword(Request $request)
    {
        ...
        if (!$admin) {
            return GlobalFunction::sendSimpleResponse(false, '管理员不存在。');
        }
        ...
        try {
            ...
            if ($request->user_password !== $decryptedPassword) {
                return GlobalFunction::sendSimpleResponse(false, '旧密码不匹配。');
            }
            ...
            return GlobalFunction::sendSimpleResponse(true, '密码修改成功。');
        } catch (\Exception $e) {
